...
@Component({
  selector: 'app-student-completion-rate',
  templateUrl: './student-completion-rate.component.html',
  styleUrls: ['./student-completion-rate.component.scss']
})
export class StudentCompletionRateComponent implements OnInit {
  isShowConfig = false;
  datas = [];
  dataItem: any;
  taiLieuItem: any;
  ...
  async loadGrid() {
    ...
    this.generalService.getThongKeTyLeHoanThanhKhoaHoc(payload).subscribe(res => {
      console.log(res);
  ...
  onExporting(e: ExportingEvent) {
    ...
    const fileName = `THONG_KE_TY_LE_HOAN_THANH_${subject?.name}.xlsx`;
