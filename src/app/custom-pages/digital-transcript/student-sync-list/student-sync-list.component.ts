...
@Component({
  selector: 'app-student-sync-list',
  templateUrl: './student-sync-list.component.html',
  styleUrls: ['./student-sync-list.component.scss']
})
export class StudentSyncListComponent implements OnInit {
  isShowEdit = false;
  datas = [];
  dataItem: any;
  taiLieuItem: any;
