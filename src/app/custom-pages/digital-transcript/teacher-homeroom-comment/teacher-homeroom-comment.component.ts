...
@Component({
  selector: 'app-teacher-homeroom-approval-mark',
  templateUrl: './teacher-homeroom-comment.component.html',
  styleUrls: ['./teacher-homeroom-comment.component.scss']
})
export class TeacherHomeroomCommentComponent implements OnInit {
  isShowEdit = false;
  datas = [];
  dataItem: any;
  taiLieuItem: any;
