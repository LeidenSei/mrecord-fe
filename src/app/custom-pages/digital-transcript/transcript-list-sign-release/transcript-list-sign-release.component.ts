...
@Component({
  selector: 'app-transcript-list-sign-release',
  templateUrl: './transcript-list-sign-release.component.html',
  styleUrls: ['./transcript-list-sign-release.component.scss']
})
export class TranscriptListSignReleaseComponent implements OnInit {
  isShowEdit = false;
  datas = [];
  dataItem: any;
  taiLieuItem: any;
